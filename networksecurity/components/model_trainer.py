...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, train_metric, test_metric, model_name):
    ...
    def train_model(self, x_train, y_train, x_test, y_test):
        ...
        self.track_mlflow(best_model=best_model, train_metric=classification_train_metric, test_metric=classification_test_metric, model_name=best_model_name)
        ...
        save_object("final_models/model.plk", best_model)
