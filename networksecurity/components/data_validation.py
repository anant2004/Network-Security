...
class DataValidation:
    ...
    def validate_no_of_columns(self, dataframe: pd.DataFrame) -> bool:
        try:
            ...
            logging.info(f"dataframe has this no of columns : {len(dataframe.columns)}")
            logging.info(f"dataframe has following columns : {dataframe.columns}")
    ...
    def detect_dataset_drift(
        ...
        try:
            ...
            for column in base_df.columns:
                ...
                report.update(
                    {column: {"p_value": float(p_value), "drift_status": drift_status}}
                )
